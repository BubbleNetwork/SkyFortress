...
public class SkyFortressBoard extends BoardPreset{
    public SkyFortressBoard() {
        super("SkyFortress",
                new BoardModuleBuilder("Server",11).withDisplay(ChatColor.BLUE + ChatColor.BOLD.toString() + "Server").build(),
                ...
                new BoardModuleBuilder("CurrentCap",4).withDisplay(ChatColor.BLUE + ChatColor.BOLD.toString() + "Fortress").build(),
                new BoardModuleBuilder("CapValue1",3).withDisplay(ChatColor.AQUA + "King: " + ChatColor.RESET).build(),
