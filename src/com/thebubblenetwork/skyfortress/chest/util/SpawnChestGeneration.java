...
public class SpawnChestGeneration extends ChestGeneration {
    ...
    static {
        ...
        //Food
        chestItems.add(new ChestItem(ChestSlot.FOOD, new HashMap<Enchantment, Integer>(), new ChestItem[0], Material.GRILLED_PORK, new int[]{4,8,16,32}, (short)0, 0.10F));
        chestItems.add(new ChestItem(ChestSlot.FOOD, new HashMap<Enchantment, Integer>(), new ChestItem[0], Material.PUMPKIN_PIE, new int[]{4,8,16,32}, (short)0, 0.10F));
        chestItems.add(new ChestItem(ChestSlot.FOOD, new HashMap<Enchantment, Integer>(), new ChestItem[0], Material.COOKED_BEEF, new int[]{4,8,16,32}, (short)0, 0.10F));
        chestItems.add(new ChestItem(ChestSlot.FOOD, new HashMap<Enchantment, Integer>(), new ChestItem[0], Material.GOLDEN_CARROT, new int[]{4,8,16,32}, (short)0, 0.5F));
    }
