...
public class SpawnChestGeneration extends ChestGeneration {
    ...
    static {
        ...
        chestItems.add(new ChestItem(ChestSlot.OTHER_WEAPON,
        ...
        chestItems.add(new ChestItem(ChestSlot.BLOCK,
                new HashMap<Enchantment, Integer>(),
                new ChestItem[0],
    ...
    private static Enchantment getEnchant(ChestSlot slot){
        if(slot.getType() == ChestSlotType.ARMOR)return Enchantment.PROTECTION_ENVIRONMENTAL;
