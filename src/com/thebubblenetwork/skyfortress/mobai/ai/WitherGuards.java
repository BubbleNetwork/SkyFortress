...
public class WitherGuards extends GameTimer{
    private Set<GuardPosition> positionSet = new HashSet<>();

    public WitherGuards(Iterable<Location> locations) {
    ...
    public WitherGuards(World w, Iterable<LocationObject> locations) {
        super(20, Integer.MAX_VALUE);
